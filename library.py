...
class librarymanagementsystem:
    def __init__(self,root):
        ...
        lblMember=Label(DataFrameLeft,bg="powder blue",text="Member type",font=("times new roman",12,"bold"),padx=2,pady=4)
        ...
        lblPRN=Label(DataFrameLeft,bg="powder blue",text="PRN No:",font=("arial",12,"bold"),padx=2,pady=4)   #PRN NUMBER
        ...
        lblTitle=Label(DataFrameLeft,font=("arial",12,"bold"),text="ID No:",padx=2,pady=4,bg="powder blue")   #TITLE
        lblTitle.grid(row=2,column=0,sticky=W)
        txtTitle=Entry(DataFrameLeft,font=("arial",13,"bold"),textvariable=self.ID_var,width=29)
        txtTitle.grid(row=2,column=1)

        lblfirstname=Label(DataFrameLeft,font=("arial",12,"bold"),text="FistName:",padx=2,pady=6,bg="powder blue")
        lblfirstname.grid(row=3,column=0,sticky=W)
        txtfirstname=Entry(DataFrameLeft,font=("arial",13,"bold"),textvariable=self.firstname_var,width=29)
        txtfirstname.grid(row=3,column=1)

        lbllastname=Label(DataFrameLeft,font=("arial",12,"bold"),text="Surname:",padx=2,pady=6,bg="powder blue")
        ...
        lblDateoverdate=Label(DataFrameLeft,font=("arial",12,"bold"),text="Date Over Date:",padx=2,pady=6,bg="powder blue")
    ...
    def showdata(self):
        ...
        self.txtbox.insert(END,"Address1: \t\t\t"+self.lastname_var.get()+"\n")
